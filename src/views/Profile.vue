  ...
  <div class="card p-2 align-items-center">
    ...
    <div class="card-body">
      <ul class="list-group list-group-horizontal justify-content-center">
        <li class="list-group-item">{{this.$store.state.acc_type=="learner" ? "Badges Earned" : "Number of Qualified Courses"}}</li>
        <li class="list-group-item">{{num_qualifications}}</li>
      </ul>
      <table class="table table-striped table-hover">
        <thead>
          <tr>
            <th>Course(s) {{this.$store.state.acc_type=="learner" ? "Completed" : "Qualified"}}</th>
          </tr>
        </thead>
        <tbody>
