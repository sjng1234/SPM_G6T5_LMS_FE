    ...
    <form class="container-fluid p-5" onsubmit="return false;">
      ...
      <div class="input-group mb-3 mt-2">
        ...
        <textarea
          type="text"
          class="form-control"
          placeholder="Cybersecurity 101 is an introductory course to cybersecurity where you get to learn..."
      ...
      <div class="mb-5 pt-2">
        <div class="d-flex">
          <h5 class="text-start fw-light mt-4">
            Pre-Requisites
            <a class="fs-6 fw-light" @click="removeOptions()">Clear</a>
          </h5>
        </div>
        ...
        <p
          class="bg-primary text-start w-25 mt-3 text-white p-2 fw-bold rounded"
          v-if="selected_prereq.length"
        >
          Selected: {{ selected_prereq.join(", ") }}
        </p>
      </div>
      <button
        type="submit"
