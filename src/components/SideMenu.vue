...
<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <!-- Find Course -->
            <li class="nav-item">
                <router-link to="/" class="nav-link align-middle px-0 d-flex flex-row align-items-center">
            ...
            <!-- My Classes -->
            <li>
                <router-link to="/MyClass" class="nav-link px-0 align-middle d-flex flex-row align-items-center">
            ...
            <!--Inbox -->
            <li>
                <router-link to="/Inbox" class="nav-link px-0 align-middle d-flex flex-row align-items-center">
